...
namespace BethanysPieShopHRM.Api.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(IEmployeeRepository employeeRepository, IWebHostEnvironment webHostEnviornment, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public IActionResult CreateEmployee([FromBody] Employee employee)
        {
            ...
            var path = $"{_webHostEnviornment.WebRootPath}\\uploads\\{employee.ImageName}";
